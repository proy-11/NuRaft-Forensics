...
cb_func::ReturnCode
ool_detect_cb(std::atomic<bool>* invoked, size_t purge_upto, cb_func::Type type, cb_func::Param* params) {
...
int main(int argc, char** argv) {
    ...
    ts.doTest(
        "remove not responding server with quorum test", rmv_not_resp_srv_wq_test, TestRange<bool>({false, true}));
